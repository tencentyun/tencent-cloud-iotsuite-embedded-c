...
class Iot:
    def __init__(self):
        ...
        self.files = {}
        self.host = 'iot.tencentcloudapi.com'
        self.uri = '/'
        self.method = "GET"
        self.debug = 1
    ...
    def PublishMsg(self):
        self.parser.add_option('--topic', dest='Topic', default='', help="Topic like: iot-abc/device1/user/get")
        self.parser.add_option('--message', dest='Message', default='{"cmd":"report","data":{"light":"on"}}',
                               help='Message content: {"cmd":"report","data":{"light":"on"}}')
        self.parser.add_option('--qos', dest='Qos', default='1',help="Message Qos : 0, 1, 2")
