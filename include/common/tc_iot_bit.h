...
#define TC_IOT_BIT_SET(m,o)     _TC_IOT_BIT_MASK_SET((m)[_TC_IOT_BIT_MASK_INDEX(m,o)],_TC_IOT_BIT_MASK_INNER(m,o))
#define TC_IOT_BIT_CLEAR(m,o)   _TC_IOT_BIT_MASK_CLEAR((m)[_TC_IOT_BIT_MASK_INDEX(m,o)],_TC_IOT_BIT_MASK_INNER(m,o))
#define TC_IOT_BIT_FLIP(m,o)    _TC_IOT_BIT_MASK_FLIP((m)[_TC_IOT_BIT_MASK_INDEX(m,o)],_TC_IOT_BIT_MASK_INNER(m,o))
